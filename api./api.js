    ...
    if (name != null && email != null && password != null && name != '' && email != '' && password != '') {
        ...
        Http.onreadystatechange = (e) => {
            if (Http.responseText != null && Http.responseText != '') {
                if (Http.status == 200) {
                    document.getElementById('output').value = "Big Account was created successful.";
                }
                else {
                    document.getElementById('output').value = "Big Account with same email already exists.";
                }
            }
            else {
